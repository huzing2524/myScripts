...
menu_url = 'https://www.ibooktxt.com/0_60/'  # 末尾必须要有斜杠/, 否则报404
chapter_urls = []
count = 1
...
chapter_urls = chapter_urls  # 子章节跳转url
# print(chapter_urls)

with open('赘婿.txt', 'w+', encoding='GB18030') as f:  # Linux中文件是UTF-8编码，Windows中文件默认是GB18030编码，小米手机阅读是会出现乱码
